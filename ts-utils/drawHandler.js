...
exports.ChunkData = exports.DrawHandler = void 0;
...
class DrawHandler {
    constructor(outlineColor, fillColor) {
        ...
        this.outlineColor = outlineColor || new rgba_1.RGBA(255, 255, 255);
        this.fillColor = fillColor || new rgba_1.RGBA(255, 255, 255);
    }
    onMouseDownFunction() {
    ...
    onUpdate(mouseX, mouseY) {
        ...
        if (this.isMouseDown) {
            this.rectangleHolder.push(new rectangle_1.Rectangle({
                x: mouseX,
                y: mouseY,
                width: 3,
                height: 3,
